...
namespace Water2D
{
    ...
    public class CloudShadowsSystem : MonoBehaviour
    {
        ...
        [SerializeField][HideInInspector] public Cryo<float> scrollSpeed = new Cryo<float>(1f);
        ...
        void Update()
        {
            ...
            mat.SetVector("_cameraSize", new Vector2(Camera.main.aspect * Camera.main.orthographicSize * 2f, Camera.main.orthographicSize * 2f));
        ...
        {
            if (theCamera == null || theSprite == null || theCamera.orthographicSize == 0 || theCamera.aspect == 0 || Screen.height == 0 || Screen.width == 0) return;
